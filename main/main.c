...
/* device name */
#define LOCAL_DEVICE_NAME    "MyMusic"
...
static void bt_av_hdl_stack_evt(uint16_t event, void *p_param)
{
    ...
    case BT_APP_EVT_STACK_UP: {
        /* set GAP callbacks and functionality - GAP is for connections */
        esp_bt_dev_set_device_name(LOCAL_DEVICE_NAME);
        esp_bt_gap_register_callback(bt_app_gap_cb);

        /* set AVCRP callbacks and functionality - AVRCP is for audio metadata */
        ...
        /* set A2DP callbacks and functionality - A2DP is for streaming audio */
